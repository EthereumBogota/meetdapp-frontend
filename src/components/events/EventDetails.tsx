		...
		>
			<VStack align='start' spacing={5}>
				...
				<Text fontSize='md' color={'#00001C'} fontFamily={'space'}>
					...
					te conectará con el poder de ser un voluntario web3!
					<br />
					<br />
					...
					<br />
					<br />
					Tendremos un preámbulo a la Blockchain Summit Latam donde conocerás
					más detalles de los beneficios que recibirás al registrarte como
					voluntario, igualmente encontrarás:
					<br />
					<br />
					🗣️ Charlas Inspiradoras: Escucha a expertos de la industria compartir
					su visión y experiencias en el mundo web3 y cómo el voluntariado puede
