      ...
      <Flex width={"100%"} maxW={"1064px"} maxHeight={'726px'} flexDirection={'column'}>
        <Flex width={"100%"} >
          ...
          <Text
            ...
            <Text
              ...
              marginTop={'24px'}
              >
             Event Records on the Blockchain
            </Text>{' '}
          </Heading>
          </StackDivider>
        </Flex>
        ...
        <Stack direction={{ base: 'column', md: 'row' }} spacing={3}>
          ...
          <Stack  w={'full'} maxW={'lg'}>
            ...
            lineHeight={'33px'}
            >
            The power of Blockchain brings an unparalleled level of transparency and immutability to event records. Each event&apos;s history, from creation to attendance, is permanently recorded, eliminating doubts and fostering trust among event organizers and attendees alike.
            </Text>
