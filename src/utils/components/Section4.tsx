      ...
      <Flex width={"100%"} maxW={"1064px"} maxHeight={'726px'} flexDirection={'column'}>
        ...
        <Stack direction={{ base: 'column', md: 'row' }} spacing={3}>
          ...
          <Stack  w={'full'} maxW={'lg'}>
            ...
            lineHeight={'33px'}
            >
            Safeguard your event experience. Our platform ensures each event remains secure and transparent, empowering you with peace of mind. Your personal data remains private, allowing you to focus wholeheartedly on what truly matters: connecting with others in a worry-free environment.
            </Text>
